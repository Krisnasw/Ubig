				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget widget-our-partners">
							...
							<ul>
								<li><a href="#">Ubig.co.id</a></li>
								<li><a href="#">Intivestudio.web.id</a></li>
								<li><a href="#">LuwakDev.id</a></li>
							</ul>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="widget widget-news-letter">
							<div class="widget-section-title">
								<h6 style="color:#fff !important">SUBSCRIBE FOR CARIKENDARAAN UPDATES</h6>
							</div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="copyright-text">
							<p>Powered by <a href="#" class="cs-color">Intive Studio.</a> Built with Heart</p>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="cs-back-to-top">
							<address>
							<i class="icon-phone"></i> <a href="#">+62 (856) 089-803-63</a>
							</address>
